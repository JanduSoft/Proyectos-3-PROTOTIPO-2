...
public class DebugConsoleInBuild : MonoBehaviour
{
    ...
    public static bool isVisible
    {
        get
        {
            return DebugConsoleInBuild.instance.visible;
        }

        set
        {
            DebugConsoleInBuild.instance.visible = value;
            if (value == true)
            {
                DebugConsoleInBuild.instance.Display();
            }
            else if (value == false)
            {
                DebugConsoleInBuild.instance.ClearScreen();
            }
        }
    }
    ...
    public static bool isDraggable
    {
        get
        {
            return DebugConsoleInBuild.instance.draggable;
        }

        set
        {
            DebugConsoleInBuild.instance.draggable = value;

        }
    }


    private static DebugConsoleInBuild s_Instance = null;   // Our instance to allow this script to be called without a direct connection.
    public static DebugConsoleInBuild instance
    {
        get
        {
            if (s_Instance == null)
            {
                s_Instance = FindObjectOfType(typeof(DebugConsoleInBuild)) as DebugConsoleInBuild;
                if (s_Instance == null)
                {
                    GameObject console = new GameObject();
                    console.AddComponent<DebugConsoleInBuild>();
                    console.name = "DebugConsoleController";
                    s_Instance = FindObjectOfType(typeof(DebugConsoleInBuild)) as DebugConsoleInBuild;
                    DebugConsoleInBuild.instance.InitGuis();
                }
    ...
    {
        DebugConsoleInBuild.instance.AddMessage(message, color);

    }
    //++++ OVERLOAD ++++
    public static void Log(string message)
    {
        DebugConsoleInBuild.instance.AddMessage(message);
    }

    public static void Clear()
    {
        DebugConsoleInBuild.instance.ClearMessages();
    }
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
